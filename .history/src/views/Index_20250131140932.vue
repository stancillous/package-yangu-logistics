            ...
            <div class="col-md-4">
              <div class="card h-100">
                <div class="card-body text-center">
                  ...
                  <p class="card-text">When you choose us, you choose reliability. Our commitment to handling your shipments with precision and care is unwavering. Rest easy knowing that your goods are in safe hands.
